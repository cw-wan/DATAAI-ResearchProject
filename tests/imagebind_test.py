from modules.imagebind import data
import torch
from modules.imagebind.models import imagebind_model
from modules.imagebind.models.imagebind_model import ModalityType

text_list = ["A dog.", "A car", "A bird"]
image_paths = [".assets/dog_image.jpg", ".assets/car_image.jpg", ".assets/bird_image.jpg"]
audio_paths = [".assets/dog_audio.wav", ".assets/car_audio.wav", ".assets/bird_audio.wav"]
video_paths = [".assets/dia0_utt0.mp4", ".assets/dia0_utt1.mp4", ".assets/dia0_utt2.mp4"]
